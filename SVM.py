...
Original file is located at
    https://colab.research.google.com/drive/1YlKsbdNKGxG5vz9OHBi6FGrtJz-N65WV
"""
...
# plot
models = ['LSTM','LogReg','SVM','RF']
accs = [0.2573,0.0669,0.9417,0.4644,0.8417,0.3640,0.9916,0.4973]
x = [1,2,4,5,7,8,10,11]
plt.bar(x,accs, color=['b','r','b','r','b','r','b','r'])
plt.bar(x[-1],accs[-1],color='r')
plt.legend(['Train Acc','Test Acc'])
plt.xticks([1,4,7,10],models)
plt.ylabel('Accuracy')
plt.title('Train & Test Accuracy Across Models')
plt.show()
